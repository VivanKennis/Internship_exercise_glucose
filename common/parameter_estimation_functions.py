...
def get_parameter_bounds(parameter_names, theta, optimize_indices, strict_bounds_parameters=[]):
    ...
    param_bounds["k_O2"] = (np.log(1e-3), np.log(1e2))    
    ...
    param_bounds["k_rec_drive"] = (np.log(1.0e-5), np.log(1e5)) 
    ...
    param_bounds["k_I_stim"] = (np.log(1.0e-3), np.log(1e5))
    param_bounds["elim_insu"] = (np.log(1.0e-2), np.log(1e0))
    param_bounds["k_I_epi"] = (np.log(1.0e-2), np.log(1e4))  
    param_bounds["k_I_nor"] = (np.log(1.0e-2), np.log(1e4))  
  
    param_bounds["Vmax_I_epi"] = (np.log(1.0e-3), np.log(1e3))  
    param_bounds["Vmax_I_nor"] = (np.log(1.0e-3), np.log(1e3)) 
    param_bounds["km_I_epi"] = (np.log(1.0e-1), np.log(1e2))  
    param_bounds["km_I_nor"] = (np.log(5e-1), np.log(1e2))  
    param_bounds["n_I_epi"] = (np.log(1.0e0), np.log(4e0))  
    param_bounds["n_I_nor"] = (np.log(1.0e0), np.log(4e0))  

    param_bounds["elim_X"] = (np.log(1.0e-3), np.log(1e0))  
    param_bounds["ins_action"] = (np.log(1.0e-5), np.log(1e1)) 
    param_bounds["Vmax_X_epi"] = (np.log(1.0e-1), np.log(1e3))
    param_bounds["k_X_epi"] = (np.log(3.0e-1), np.log(1e1))
    param_bounds["km_X_epi"] = (np.log(3.0e-1), np.log(1e1))

    param_bounds["elim_glu"] = (np.log(1.0e-4), np.log(1e1))
    
    param_bounds["k_Gpro_stim"] = (np.log(1.0e-5), np.log(1e5))
    param_bounds["k_Gpro_decay"] = (np.log(1.0e-2), np.log(1e1))
    param_bounds["k_Gprod_epi"] = (np.log(1.0e-5), np.log(1e5))
    param_bounds["k_Gprod_nor"] = (np.log(1.0e-5), np.log(1e5))
    param_bounds["Vmax_Gprod_epi"] = (np.log(1.0e-5), np.log(1e1))
    param_bounds["Vmax_Gprod_nor"] = (np.log(1.0e-5), np.log(1e1))
    param_bounds["km_Gprod_epi"] = (np.log(2.0e-1), np.log(1e1))
    param_bounds["km_Gprod_nor"] = (np.log(5.0e-1), np.log(1e1))
    param_bounds["n_Gprod_epi"] = (np.log(1.0e0), np.log(5e0))
    param_bounds["n_Gprod_nor"] = (np.log(1.0e0), np.log(4e0))
    
    param_bounds["K_Gup_stim"] = (np.log(1.0e-5), np.log(1e5))
    param_bounds["k_Gup_decay"] = (np.log(1.0e-2), np.log(1e1))

    param_bounds["Vmax_Ie"] = (np.log(1.0e-5), np.log(1e3))
    param_bounds["km_Ie"] = (np.log(3e-1), np.log(1e2))
    param_bounds["n_Ie"] = (np.log(1.0e-0), np.log(4e0))

    param_bounds["k_Ie_decay"] = (np.log(1.0e-2), np.log(1e2))

    param_bounds["k"] = (np.log(1.0e-4), np.log(1.31e-2))
    param_bounds["T1"] = (np.log(1.86e0), np.log(1.014e1))
